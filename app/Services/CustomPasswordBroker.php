...
{    
     ...
     * @return void
     */
    public function __construct(CustomDatabaseTokenRepository $tokens,
                                UserProvider $users)
    {
        $this->users = $users;
        $this->tokens = $tokens;
    ...
    public function reset(array $credentials, Closure $callback)
    {
        ...
        $password = $credentials['constacl_single_users_password'];
    ...
    public function validateNewPassword(array $credentials)
    {
        if (isset($this->passwordValidator)) {
            [$password, $confirm] = [
                $credentials['constacl_single_users_password'],
                $credentials['constacl_single_users_password_confirmation'],
            ];
