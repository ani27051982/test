...
class constacl_single_users extends Authenticatable
{
    ...
    protected $primaryKey = 'constacl_single_users_id';
    ...
    {
        return $this->hasMany('App\constacl_single_users_logged_data','constacl_single_users_id');
    }
    
    public function getEmailForPasswordReset()
    {
        return $this->constacl_single_users_email;
    }
    
    public function getAuthPassword()
    {
        return $this->constacl_single_users_password;
    }
