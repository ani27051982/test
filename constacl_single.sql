...
(28, 158, 'bHJtcU9UaTkxanZlN1FTU3k3cjNnQT09', '0', '2019-01-18 07:32:09'),
(29, 158, 'eE9wWUpEczFyY3lMczg1NFE4Q1NRUT09', '0', '2019-01-21 12:10:30'),
(30, 158, 'eE9wWUpEczFyY3lMczg1NFE4Q1NRUT09', '0', '2019-01-22 04:34:48'),
(31, 158, 'bHJtcU9UaTkxanZlN1FTU3k3cjNnQT09', '0', '2019-01-22 04:42:42'),
(32, 158, 'M3d6Q2FvakkxWVBDdlo0MDUvMVlMQT09', '0', '2019-01-22 04:45:48'),
(33, 158, 'dEFDdWRZQ1grejQyTVFJbFlNQ0pGZz09', '1', '2019-01-22 06:19:29');
...
(158, 'Constacloud test', 'animesh27051982@gmail.com', 'animesh27051982@gmail.com', '4343656', 'superadmin', 'dEFDdWRZQ1grejQyTVFJbFlNQ0pGZz09', '2019-01-17 07:15:59', '2019-01-22 06:19:29', 0, 0, '1', '$2y$10$0LcUVfc02st4Wd9E4zN8UOmpWIQZ3bAur1Uw8SkMQruf.zI.m8Yjy', '1', '2019-01-22 06:23:58', '1', '0');
...
CREATE TABLE `constacl_single_users_logged_data` (
  ...
  `constacl_single_users_logged_out_time` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `constacl_single_users_logged_data`
--

INSERT INTO `constacl_single_users_logged_data` (`constacl_single_users_logged_data_id`, `constacl_single_users_id`, `constacl_single_users_logged_in_time`, `constacl_single_users_logged_out_time`) VALUES
(1, 158, '2019-01-22 07:45:44', '2019-01-22 08:48:42'),
(2, 158, '2019-01-22 07:53:24', '2019-01-22 08:48:08'),
(3, 158, '2019-01-22 08:04:17', '2019-01-22 08:52:03'),
(4, 158, '2019-01-22 08:56:37', '2019-01-22 09:01:32'),
(5, 158, '2019-01-22 09:27:43', NULL);
...
--
ALTER TABLE `constacl_single_passwords`
  MODIFY `constacl_single_passwords_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `constacl_single_users`
--
ALTER TABLE `constacl_single_users`
  MODIFY `constacl_single_users_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;

--
-- AUTO_INCREMENT for table `constacl_single_users_logged_data`
--
ALTER TABLE `constacl_single_users_logged_data`
  MODIFY `constacl_single_users_logged_data_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `constacl_single_passwords`
  ADD CONSTRAINT `user_id_foreign_password` FOREIGN KEY (`constacl_single_passwords_users_id`) REFERENCES `constacl_single_users` (`constacl_single_users_id`) ON DELETE CASCADE;

--
-- Constraints for table `constacl_single_users_logged_data`
--
ALTER TABLE `constacl_single_users_logged_data`
  ADD CONSTRAINT `user_id_foreign_key_logged` FOREIGN KEY (`constacl_single_users_id`) REFERENCES `constacl_single_users` (`constacl_single_users_id`) ON DELETE CASCADE;

--
-- Constraints for table `constacl_single_users_roles_access`
--
ALTER TABLE `constacl_single_users_roles_access`
  ADD CONSTRAINT `user_id_foreign_key_role` FOREIGN KEY (`constacl_single_users_id`) REFERENCES `constacl_single_users` (`constacl_single_users_id`) ON DELETE CASCADE;
COMMIT;
